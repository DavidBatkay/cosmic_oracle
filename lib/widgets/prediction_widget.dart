...
/// A widget that displays a prediction inside a floating, animated rhombus.
///
/// If no prediction is provided, it displays the number "8".
class PredictionWidget extends StatefulWidget {
  /// The prediction to display.
  final Prediction? prediction;

  /// Creates a prediction widget.
...
/// A custom painter that draws a floating, animated rhombus.
class RhombusPainter extends CustomPainter {
  /// The color of the rhombus.
  final Color color;

  /// The current value of the animation, used to distort the rhombus.
  final double animationValue;

  /// Creates a rhombus painter.
